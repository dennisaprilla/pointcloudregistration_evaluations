...
%     load('OptData/OptSaver')
    load(strcat(pwd, '/functions/optimizers/CMAES', '/OptData/OptSaver'));
    val_list = [val_list; fitness.hist(1) Tend];
%     save('OptData/OptSaver.mat','val_list','i_opts', 'xmean'); clear val_list i_opts
    save(strcat(pwd, '/functions/optimizers/CMAES', '/OptData/OptSaver.mat'), ...
         'val_list','i_opts', 'xmean'); clear val_list i_opts
...
%   save('OptData/OptSaver.mat','val_list','i_opts'); clear val_list i_opts
    ...
    save(strcat(pwd, '/functions/optimizers/CMAES', '/OptData/OptSaver.mat'), ...
         'val_list', 'i_opts'); clear val_list i_opts
