...
for trial=1:n_trials 
    ...
    % the point cloud
    Ua_ultrafinereg = (R_ultrafinereg * Ua_noised' + t_ultrafinereg')';
    % transform the U_breve just for visualization (not for calculation)
    U_breve_ultrafinereg = (R_ultrafinereg * U_breve' + t_ultrafinereg')';
    ...
    if (displaybone)
        ...
        delete(findobj('Tag', 'plot_Ua_noised'));
        plot3( axes1, ...
               U_breve_ultrafinereg(:,1), ...
               U_breve_ultrafinereg(:,2), ...
               U_breve_ultrafinereg(:,3), ...
               '.', 'Color', [0.9290 0.6940 0.1250], ...
               'MarkerSize', 0.1, ...
               'Tag', 'plot_U_breve_fineregCS');
        plot3( axes1, ...
